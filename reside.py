...
if __name__ == "__main__":
    ...
    parser.add_argument('-data', dest="dataset", default="data/riedel_processed.pkl", required=False,
                        help='Dataset to use')
    ...
    parser.add_argument('-name', dest="name", default="new_run_" + str(uuid.uuid4()), help='Name of the run')
